    ...
    <footer class="bg-[#f2eded] py-4 px-10 font-sans tracking-wide">
      <div class="lg:max-w-[50%] mx-auto text-center">
        <h3 class="text-3xl font-bold text-gray-800">
          <Link to={"/contact"}>
            <Button bg={"none"}>Contacter Nous</Button>
          </Link>
        </h3>
        <p class="text-sm mt-1 text-gray-500">
          Trouvez les réponses à vos questions en nous contactant directement.
          Nous sommes là pour vous fournir le soutien dont vous avez besoin.
        </p>
      </div>
      ...
      <div class="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          <h4 class="text-lg font-bold mb-6 text-gray-800">
            N'hésitez pas à nous contacter pour toute question ou assistance
            supplémentaire. Notre équipe est là pour vous aider à chaque étape
            du chemin.
          </h4>
          <p class="text-gray-500 mb-2 text-sm">
            Contactez-nous facilement pour toute question ou préoccupation.
            Notre équipe est disponible pour vous apporter une assistance
            personnalisée
          </p>
        </div>
