...
const ContactPage = () => {
    return (
      ...
      <div class="text-center px-6">
          <h2 class="text-gray-800 text-3xl font-extrabold">Contacter Nous</h2>
          <p class="text-sm text-gray-500 mt-4">Have some big idea or brand to develop and need help?</p>
      </div>

      <div class="!text-white grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
